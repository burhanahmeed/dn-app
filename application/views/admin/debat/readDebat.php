                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="form-group">
                            <a href="<?php echo base_url('admin/debat/sortby/verified') ?>" class="btn btn btn-primary btn-sm button-gray">Terverifikasi</a>
                            <a href="<?php echo base_url('admin/debat/sortby/unverified') ?>" class="btn btn btn-primary btn-sm button-gray">Belum Terverifikasi</a>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo '<a href="'.base_url().'admin/debat/editView/'.$row['uid'].'"
